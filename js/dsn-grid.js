...
function dsnGridProgressCircle(wind) {
    ...
    e.css({position: 'fixed', left: '30px', bottom: '38px', width: '52px', height: '52px', 'z-index': '99999999'});
    ...
    video.each(function (e) {
        ...
        _e.on('click', function () {
            ...
            if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent)) {
                $('body,html').animate({ scrollTop: (_e.offset().top + 60) - document.documentElement.clientHeight / 2 });
            } else {
