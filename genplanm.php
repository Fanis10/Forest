...
echo '
          ...
          <div style="" class="form-field">
                      <p style="font-family: '.$m.';font-size: 28px;">
                    Участок №'.$ground['g'].'
                    </div>
                    <div class="form-field">
                     <p style="font-family: '.$m.';font-size: 28px;    margin-top: 15px;">
                    Площадь: '.$ground['sotka'].' соток </p>
                    </div>
                      <div class="form-field">
                   <p style="font-family: '.$m.';font-size: 28px;    margin-top: 15px; margin-bottom: 15px;">
                    Стоимость: '.$price.' ₽</p>
                    </div>
...
echo '
          ...
          <div style="margin-top: 20px;" class="form-field">
                      <p style="font-family: '.$m.';font-size: 24px;">
                    Участок №'.$ground['g'].'
                    </div>
                    <div class="form-field">
                     <p style="font-family: '.$m.';font-size: 24px;    margin-top: 12px;">
                    Площадь: '.$ground['sotka'].' соток </p>
                    </div>
                           <div class="form-field">
                   <p style="font-family: '.$m.';font-size: 24px;    margin-top: 12px;">
                    Стоимость: '.$price.' ₽</p>
                               ...
                               <div class="form-field">
                   <p style="font-family: '.$m.';font-size: 24px;    margin-top: 12px; margin-bottom: 12px;">
                    Проект: '.ruProject($ground['project']).' </p>
                    </div>
                    
                  <div><a href="/projects/?house='.$ground['g'].'"><img style="width:100%" class="imgmap" src="projectsImages/'.$ground['project'].'.webp"/></a></div>
