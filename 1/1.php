...
<head>
    ...
    <link rel="stylesheet" href="1/style2.css?v<?= hash_file('md5', '1/style.css') ?>" />
...
.ww:hover{
    ...
    width: 645px;
    height: 123px;
    background-image: url("1/img/whatsapp2.png");
    transition: 0.3s;
    z-index: 1111;
}
...
color: #fff;
    ...
    cursor: pointer;
        ...
        .drop{
            filter:drop-shadow(2px 4px 2px #E1CB03);
        }
           .drop2{
            filter:drop-shadow(2px 4px 2px #E1CB03);
        }
    ...
    <script type="text/javascript" async>
        ...
        <? if ($_GET['thankyou'] == 'view')
            echo "ym(99675390,'reachGoal','forma');";
        ?>
    </script>
...
<body style="    line-height: 0;">
    ...
    <div class="element">
        <div class="div">
           ...
           <a target="_blank" href="https://wa.me/79600423210">  <div class="ww"></div></a>
...
gap: 0px;
opacity: 0px;
" class="hspan clbck" clbck="about">
О ПРОЕКТЕ
</span>

 <a href="/projects.html"> <span style="width: 140px;
height: 34px;
top: 38px;
left: 518px;
gap: 0px;
...
" class="hspan clbck" clbck="concept">
КОНЦЕПЦИЯ
</span>


 <a href="/map.php"> <span style="width:134px;
height:34px;
top: 38px;
left: 908px;
gap: 0px;
...
ГЕНПЛАН
  ...
  <a href="/?houses"> <span style="width:184px;
height: 34px;
top: 38px;
left: 1078px;
gap: 0px;
...
" class="hspan clbck" clbck="credit">
НАШИ ДОМА
</span>
   </a>              
         
 <a href="/timeline.html"><span style="width:95px;
height: 34px;
top: 38px;
left: 1293px;
gap: 0px;
...
" class="hspan clbck" clbck="pulse">
ПУЛЬС
</span></a>
                  
 <a  href="tel:+7 927 494-45-58">    <span style="width:232px;
height: 34px;
top: 38px;
left: 1433px;
gap: 0px;
...
<div class="leed" style="position: relative;
width: 425px;
height: 83px;
background-color: #e1ca03;
border-radius: 40px;
box-shadow: 0px 0px 4px #000000c7; cursor: pointer;"><div style="position: absolute;
top: 20px;
left: 20px;
...
letter-spacing: 0;
line-height: 43.8px;
white-space: nowrap; cursor: pointer;" >ОСТАВИТЬ ЗАЯВКУ</div></div>
          </div>
          
   <div id="step1">
   
   <span style="color: #FFF;
text-shadow: 5px -2px 8.9px rgba(0, 0, 0, 0.41);
font-family: Montserrat;
font-size: 81px;
font-style: normal;
font-weight: 900;
line-height: 134%; /* 108.54px */
...
height:109px;
width:931px;
">Проект в подарок</span>

<span style="position: absolute; top: 1120px; left: 144px; width: 1457px; height: 55px;color: #FFF;
text-align: center;
...
letter-spacing: -0.46px;"> Оставьте запрос и получите проекты с ценами в <b style="color: #FFE605; font-weight: bold;">подарок:</b> </span>
   
 <img style="width: 425px;
height: 14px; position: absolute; left: 193px; top: 1228px;" src="1/img/line-active.png" />  
  <img style="width: 425px;
height: 14px; position: absolute; left: 654px; top: 1228px;" src="1/img/line.png" />  
 <img style="width: 425px;
height: 14px; position: absolute; left: 1114px; top: 1228px;" src="1/img/line.png" />  
  

<span style="position: absolute; top: 1296px; left: 220px;color: #FFF;
text-shadow: 5px -2px 8.9px rgba(0, 0, 0, 0.41);
font-family: Montserrat;
font-size: 54px;
font-style: normal;
font-weight: 900;
line-height: 134%; /* 72.36px */
text-transform: uppercase;">домовладение</span>
 
<span style="position: absolute; top: 1296px; left: 1106px;color: #FFF;
text-shadow: 5px -2px 8.9px rgba(0, 0, 0, 0.41);
font-family: Montserrat;
font-size: 54px;
font-style: normal;
font-weight: 900;
line-height: 134%; /* 72.36px */
text-transform: uppercase;">участок</span> 
  
 <img data-name="Домовладение" class="qq" style="position: absolute; left: 149px; top:1393px;" src="1/img/q1.webp" /> 
  <img data-name="Участок" class="qq" style="position: absolute; left: 916px; top:1393px;" src="1/img/q2.webp" /> 
  
  <img id="continue1" style="position: absolute; left: 1226px; top: 1829px; cursor: pointer; width: 408px;" src="1/img/continue.png" />
...
height: 14px; position: absolute; left: 193px; top: 1228px;" src="1/img/line-active.png" />  
  <img style="width: 425px;
height: 14px; position: absolute; left: 654px; top: 1228px;" src="1/img/line-active.png" />  
 <img style="width: 425px;
height: 14px; position: absolute; left: 1114px; top: 1228px;" src="1/img/line.png" />  
  

<span style="position: absolute; top: 1296px; left: 414px;color: #FFF;
text-shadow: 5px -2px 8.9px rgba(0, 0, 0, 0.41);
font-family: Montserrat;
font-size: 54px;
font-style: normal;
font-weight: 900;
line-height: 134%; /* 72.36px */
text-transform: uppercase;">ВЫБЕРИТЕ ПЛОЩАДЬ ДОМА</span>
 

  
 <img data-name="78-85м2" class="qq2" style="position: absolute; left: 163px; top:1430px; width: 612px; height: 116px; cursor: pointer;" src="1/img/q2-1.png" /> 
  <img data-name="96-116м2" class="qq2" style="position: absolute; left: 163px; top:1580px; width: 612px; height: 116px; cursor: pointer;" src="1/img/q2-3.png" /> 
   <img data-name="116-142м2" class="qq2" style="position: absolute; left: 941px; top:1430px; width: 612px; height: 116px; cursor: pointer;" src="1/img/q2-2.png" /> 
  <img data-name="Более 142м2" class="qq2" style="position: absolute; left: 941px; top:1580px; width: 612px; height: 116px; cursor: pointer;" src="1/img/q2-4.png" /> 
  
  <img id="continue2" style="position: absolute; left: 1226px; top: 1829px; cursor: pointer; width: 408px;" src="1/img/continue.png" />
  
   
   </div>
   
   
     <div style="display: none;" id="step21">
...
<span style="position: absolute; top: 1296px; left: 336px;color: #FFF;
text-shadow: 5px -2px 8.9px rgba(0, 0, 0, 0.41);
font-family: Montserrat;
font-size: 54px;
font-style: normal;
font-weight: 900;
line-height: 134%; /* 72.36px */
text-transform: uppercase;">ЦЕЛЬ ИСПОЛЬЗОВАНИЯ УЧАСТКА</span>
 

  
 <img data-name="Построить дом" class="qq21" style="position: absolute; left: 166px; top:1515px; height: 156px; cursor: pointer;" src="1/img/q21-1.png" /> 
  <img data-name="Инвестиции" class="qq21" style="position: absolute; left: 930px; top:1515px; height: 156px; cursor: pointer;" src="1/img/q21-2.png" /> 

  <img id="continue21" style="position: absolute; left: 1226px; top: 1829px; cursor: pointer; width: 408px;" src="1/img/continue.png" />
...
height: 14px; position: absolute; left: 1114px; top: 1228px;" src="1/img/line.png" />  
   ...
   <span style="position: absolute; top: 1336px; left: 210px;color: #FFF;
text-shadow: 5px -2px 8.9px rgba(0, 0, 0, 0.41);
font-family: Montserrat;
font-size: 54px;
font-style: normal;
font-weight: 900;
line-height: 134%; /* 72.36px */
text-transform: uppercase;"> каким способом удобнее получить  <b style="color: #FFE605; font-weight: bold; margin-left: 290px;"> проекты с ценами: </b></span> 
    


 <img data-name="Whatsapp" class="continue3 qq3" style="position: absolute; left: 548px; top:1496px;cursor: pointer; width: 637px; height: 116px;" src="1/img/q3-1.png" /> 
  <img data-name="Telegram" class="continue3 qq3" style="position: absolute; left: 548px; top:1642px; cursor: pointer; width: 637px; height: 116px;" src="1/img/q3-2.png" /> 
   <img data-name="Звонок" class="continue3 qq3" style="position: absolute; left: 548px; top:1787px; cursor: pointer; width: 637px; height: 116px;" src="1/img/q3-3.png" /> 
...
height: 14px; position: absolute; left: 654px; top: 1228px;" src="1/img/line-active.png" />  
 <img style="width: 425px;
height: 14px; position: absolute; left: 1114px; top: 1228px;" src="1/img/line-active.png" />  
  
   
   
   <span style="position: absolute; top: 1336px; left: 526px;color: #FFF;
text-shadow: 5px -2px 8.9px rgba(0, 0, 0, 0.41);
font-family: Montserrat;
font-size: 54px;
font-style: normal;
font-weight: 900;
line-height: 134%; /* 72.36px */
text-transform: uppercase;"> введите контакты</span> 
    
<input id="qname" class="inp" style="position: absolute; top:1516px; left: 514px; width: 669px; color:white; background: transparent; border: none; border-bottom: 1px solid #fff; outline: none; font-size: 43px;" type="text" placeholder="Ваше имя" />
<input id="qpass" class="inp" style="position: absolute; top:1619px; left: 514px; width: 669px; color:white; background: transparent; border: none; border-bottom: 1px solid #fff; outline: none; font-size: 43px;" type="tel" placeholder="Номер телефона" />

<img style="position: absolute; top: 1730px; left: 654px;" src="1/img/radio.png" />
<span style="position: absolute; top: 1707px; left: 702px; display: flex;
width: 402px;
height: 70px;
...
font-weight: 500;
line-height: normal;
font-variant: small-caps; color: white;"> Нажимая кнопку «Отправить» я соглашаюсь с <a href="privacy-policy.pdf" style="text-decoration: underline; color: white;">Пользовательским соглашением </a></span>
 
 
 <img id="send" style="position: absolute; top: 1813px; left: 702px; width: 283px; height: 73px; cursor: pointer;" src="1/img/send.png" />
 ...
 <a target="_blanc" href="https://wa.me/79600423210">  <div style="width: 637px; height: 116px; position: absolute; top: 1738px; left:960px"></div></a>
  <img style="position: absolute; top:1011px;" src="1/img/q4.png" /> 
  <img style="position: absolute; left: 960px; top:1738px;" src="1/img/q4-w.png" /> 
  <img style="position: absolute; left: 672px; top:1153px;" src="1/img/q4-l.png" /> 
      ...
      <div class="menu_wrapper">
        <div style="line-height:1;" class="menu_container">
          ...
          <div class="menu_list">
            ...
            <div class="mobile_soc">
              ...
              <a
                ...
                >YOUTUBE</a
              >&nbsp;&nbsp;&nbsp;&nbsp;
              <a target="_blank" class="social2" href="https://t.me/ZEMLYA_RT"
                >ТЕLEGRAM</a
              >
            </div>
          </div>
          <div style="line-height:1.6;" class="menu_contacts">
            ...
            <div id="about" class="text-wrapper-3">О ПРОЕКТЕ</div>
            <img class="img" src="1/img/forest.webp" />
            
        <a href="https://vkvideo.ru/video-61167957_456240011" target="_blank"> <img style="position: absolute; left: 570px; top: 2312px; height: 90px; " src="1/img/play-video.png" /></a>
            
            
            <p class="FOREST">
              
                <span class="span">
                 Это ваш уютный дом на краю леса, напрямую от надежного застройщика, с индивидуальной планировкой, благоустроенной "<b style="font-weight: bold;">под ключ</b>" территорией, в <b style="font-weight: bold;">7-и минутах</b> ходьбы от садика, школы, полной инфраструктуры и <b style="font-weight: bold;">9 минут езды от центра Казани </b> по новому <b style="font-weight: bold;"> Вознесенскому тракту</b></span>
            ...
            <div style="top: 3083px;    left: 891px; position: absolute; border-radius: 10%;">
            ...
            <div id="concept" class="overlap-7">
                    ...
                    <div class="splide__track">
                        ...
                        безопасность." data-title="БЕЗОПАСНОСТЬ"><img class="img-8" src="1/img/slider/1.webp" /></li>
                            ...
                            <li class="splide__slide" data-desc="Мечеть с общественным пространством в поселке: современный дизайн, место для духовности и собраний в гармонии с природой." data-title="МЕЧЕТЬ">
                                <img class="img-8" src="1/img/slider/slider13.webp" />
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div id="genplan" style="top: 7850px; position: absolute;">
                <? require("svg.php"); ?>
     ...
     <div class="booking_modal">
            ...
            echo ' <div class="thx" style="overflow-y: scroll;
    display: flex;
    position: fixed;
    top: 0;
    z-index: 9999;
    ...
    padding-top: 30px;">
           <a target="_blanc" href="https://wa.me/79600423210">  <img style="position: absolute; left: 490px;    z-index: 1111;    width: 742px;    height: 412px;
    bottom: 140px;" src="1/img/thx.svg" /></a>
             
               <div style="position: absolute; width: 637px; height: 116px; top: 1315px; left: 855px;"></div>
          
             <div style="background-color: rgba(35, 35, 35, 0.9);
    position: fixed;
    top: 0;
    width: 100%;
    height: 100%;
    ...
    overflow: hidden;
    pointer-events: all;cursor:pointer;" class="thx-close">
                </div>
...
$("#continue1").on("click",function(){
    ...
    $("#step1").hide();
    if ($(".drop").attr("data-name")=='Домовладение')
    $("#step2").show();
    else $("#step21").show();
});
...
$(".qq2").on("click",function(){
    ...
    $(".qq2").removeClass("drop2");
  
    $(this).addClass("drop2");
    
  
});
$(".qq21").on("click",function(){
    
    $(".qq21").removeClass("drop2");
...
$("#send").on("click",function(){
   ...
   ym(99675390,'reachGoal','lead');
    
    ss =  $(".drop").attr("data-name") + " " +  $(".drop2").attr("data-name") + " " +  $(".drop3").attr("data-name");
...
$(".thx-close").on("click", function(){
    
    $(".thx").hide();
});
         
                $(document).on("click",".leed",function(){
                        document.querySelector('body').style['overflow'] = 'hidden';
